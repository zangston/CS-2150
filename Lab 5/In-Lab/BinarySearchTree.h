...
private:
  ...
  void recursiveInsert(const string &x, BinaryNode *& n) const;
  string recursivePathTo(const string &x, BinaryNode *n) const;
  bool recursiveFind(const string &x, BinaryNode *n) const;
  int recursiveNumNodes(BinaryNode *n) const;
};
